...
If you've been away for a few months, read this first; the surface has shifted faster than the mental models. Last reviewed against Claude Code v2.1.141 (latest weekly digest: Week 19, v2.1.128–v2.1.136) and the docs at `code.claude.com/docs` as of mid-May 2026.
...
*Last reviewed: 2026-05-14 against Claude Code v2.1.141 (latest weekly digest: Week 19, v2.1.128–v2.1.136; per-version changelog at `code.claude.com/docs/en/changelog`, weekly digests at `code.claude.com/docs/en/whats-new`). Treat dated content as a snapshot; verify against current docs before relying on details. PRs and corrections welcome.*
