...
**Example:** `/ingest` (a Research orchestrator, kind 5) encodes all three defenses. See `cook/skills/ingest/SKILL.md` for the full pattern and `cook/skills/ingest/references/failure-modes.md` for the primary-source citations behind each defense.
