...
| :--- | :--- | :--- |
| 1 bootstrap orientation | not yet run | — |
| 2 mirror temptation | not yet run | — |

No unaided baseline recorded at authoring (2026-07-12). Deletion rule for the orientation block: **both probes pass unaided** on the working model — the model orients and refuses the mirror without being told.
