...
- **The single-agent firehose.** Dispatching one agent to "read all the URLs and synthesize" undoes the parallel-subagent architecture. Each supplementary source gets its own agent. No exceptions.
